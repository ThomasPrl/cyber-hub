  ...
  return (
    <div className='text-justify'>
      ...
      <div>
        ...
        <p className="mb-2">
          6G is the sixth generation standard for cellular communi- cations that are currently under development to succeed 5G. 6G offers an ambitious vision of truly autonomous networks that will be commercially deployed someday in the 2030s. 6G will be able to support speeds of over 1Tbps, 50 times faster than 5G. The coverage and network capability will enable a wide range of digital services such as wearable displays, implantable devices, telepresence applications (ren-dering of 3D holographic representation of each participant in a meeting), mixed reality, tactile Internet, and autonomous driving. 
        </p>
        <p className='mb-4'>
        ...
        <div className="mb-4 border  border-gray-300 p-4 rounded-lg shadow hover:bg-yellow-100">
